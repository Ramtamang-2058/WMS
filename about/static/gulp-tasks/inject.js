...
gulp.task('injectAssets', function () {
    return gulp.src(["./**/*.html"])
        .pipe(inject(gulp.src([
            ...
            './{% static 'assets/vendors/js/vendor.bundle.base.js',
        ], {
            read: false
        }), {
            name: 'plugins',
        ...
        .pipe(inject(gulp.src([
            // './{% static 'assets/css/shared/style.css',
            './{% static 'assets/js/off-canvas.js',
            './{% static 'assets/js/hoverable-collapse.js',
            './{% static 'assets/js/misc.js',
        ], {
            read: false
        }), {
            relative: true
...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('pages/**/*.html', {
        ...
        .pipe(replace('src="{% static 'assets/images/', 'src="../../{% static 'assets/images/'))
